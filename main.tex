...
\addcommitteemember{西安交通大学,李昊,副教授}
\addcommitteemember{西安交通大学,赵英良,教授}
\addcommitteemember{西安交通大学,赵玺,副教授}
\addcommitteemember{西安交通大学,陈妍,副教授}
\addcommitteemember{西安交通大学,王志文,副教授}

% 答辩时间（手动指定）
% Defence date, input manually
\defensedate{2024}{05}{14}

% 答辩地点（涉密论文请手动设置为「西安交通大学」）
% Defence location, default value is 「西安交通大学」
\defenseloc{创新港4-6208}

% 常规审阅人 要求和答辩委员会委员一样
% General reviewer list, same requirements as the committee member
% \addgeneralreviewer{哈尔滨工业大学,孙鑫,副教授}
